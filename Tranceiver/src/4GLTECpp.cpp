...
int main() {
	for (int var = 0; var < 1; ++var) {
		...
		Decoder dec = Decoder();
		Channel ch = Channel("High", "EPA 5Hz", 5, dec.getSigma() / sqrt(2));
		double lc = 2.5;
		int iterations = 6;
	...
	/*
		...
		cout << endl << "total time               = "
				<< (encode_time_full + modulate_time_full + fft_time_full
						+ ifft_time_full + multiplex_time_full+demapper_time_full+equalizer_time_full+demodulator_time_full+decoder_time_full) / 1000 << " ms"
				<< endl;
